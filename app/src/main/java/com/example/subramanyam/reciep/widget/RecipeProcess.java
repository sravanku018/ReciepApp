package com.example.subramanyam.reciep.widget;
...
import com.example.subramanyam.reciep.R;
import com.example.subramanyam.reciep.RecipList;

import java.util.ArrayList;

import static com.example.subramanyam.reciep.widget.UpdateBakingService.*;
...
public class RecipeProcess extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        Intent appIntent=new Intent(context, RecipList.class);
